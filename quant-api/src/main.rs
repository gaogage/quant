...
async fn main() {
    ...
    let app = Router::new()
        ...
        .route("/api/v1/quant/data/sync/daily/background", post(routes::sync::sync_daily_background))
        .route("/api/v1/quant/data/sync/tasks/{task_id}", get(routes::sync::sync_task_status))
        .route("/api/v1/quant/data/sync/adj-factor", post(routes::sync::sync_adj_factor))
        .route("/api/v1/quant/data/sync/adj-factor/background", post(routes::sync::sync_adj_factor_background))
        ...
        .route("/api/v1/quant/factors/batch-sync/background", post(routes::factors::batch_sync_factors_background))
        .route("/api/v1/quant/factors/evaluate-all", post(routes::factors::evaluate_all_factors))
        .route("/api/v1/quant/factors/evaluate-all/background", post(routes::factors::evaluate_all_factors_background))
