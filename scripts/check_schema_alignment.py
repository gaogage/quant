...
if factor_routes.exists():
    ...
    for required in [
        ...
        "phase7_cashflow_quality_backfill_specs",
        "phase7_dividend_quality_backfill_specs",
        ...
        "phase7_cashflow_latest_backfill_sql",
        "phase7_dividend_rolling_quality_backfill_sql",
